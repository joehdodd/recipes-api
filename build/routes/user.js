    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            user = _context2.sent;
            return _context2.abrupt('return', res.status(200).json({ message: 'Ok', data: user }));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            return _context3.abrupt('return', res.status(400).json({ message: 'That username is taken. Please choose another.' }));
